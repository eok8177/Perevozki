            ...
            <ul class="carpark">
                <li v-for="item in cars" class="carpark__item">
                    <div class="carpark__item-image">
                      <router-link :to="'/avtopark-gruzovoe-taksi/'+item.slug" class="carpark__item-title">
                        <img :src="item.img" alt="">
                      </router-link>
                    </div>
                    <div class="carpark__item-info">
                        <router-link :to="'/avtopark-gruzovoe-taksi/'+item.slug" class="carpark__item-title">{{item.title}}</router-link>
