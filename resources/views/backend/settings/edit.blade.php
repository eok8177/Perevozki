...
@section('content')
  <div class="setting-heading">
    <h1 class="setting-title">Edit setting {{ $setting->id }}</h1>
  </div>
  ...
  {!! Form::open(['route' => ['admin.settings.update', $setting->id], 'method' => 'PUT']) !!}
        ...
        <div class="ibox">
          <div class="ibox-body">
            <div class="form-group">
                ...
                {{ Form::text('slug', $setting->slug, ['class' => $errors->has('slug') ? 'form-control is-invalid' : 'form-control']) }}
                @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                {{ Form::select('status', [true => 'Yes', false => 'No'], $setting->status, ['class' => $errors->has('status') ? 'form-control is-invalid' : 'form-control']) }}
      ...
      <div class="col-md-6">
        <div class="ibox">
          ...
          <div class="ibox-body">
            <img id="holder" style="max-height:100px;" src="{{ $setting->image }}">
          </div>
          <div class="ibox-footer pl-4">
            ...
            <a id="delete-image" class="btn btn-danger {{($setting->image) ? '' : 'hidden'}}">
              <i class="icon icon-trash"></i> Delete
            </a>
            <input id="thumbnail" class="form-control" type="hidden" name="image" value="{{ $setting->image }}">
          </div>
        </div>
      </div>
    </div>
