    ...
    $('.color-skin-box input:radio').change(function() {
        ...
        if(val != 'default') {
            if(! $('#theme-style').length ) {
                $('head').append( "<link href='/backend/css/themes/"+val+".css' rel='stylesheet' id='theme-style' >" );
            } else $('#theme-style').attr('href', '/backend/css/themes/'+val+'.css');
